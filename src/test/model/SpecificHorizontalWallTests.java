...
public class SpecificHorizontalWallTests extends GameTests{
    ...
    public void testPlaceOutOfBoundsHorizontalWallBottomRight() {
        ...
        try {
            ...
            //cell to the top left of wall
            assertFalse(game.getBoard().get(Game.SIDE_LENGTH * Game.SIDE_LENGTH - 2).isWallUp());
            assertFalse(game.getBoard().get(Game.SIDE_LENGTH * Game.SIDE_LENGTH - 2).isWallLeft());
            assertFalse(game.getBoard().get(Game.SIDE_LENGTH * Game.SIDE_LENGTH - 2).isWallDown());
            assertFalse(game.getBoard().get(Game.SIDE_LENGTH * Game.SIDE_LENGTH - 2).isWallRight());
    ...
    public void testRightOverlapHorizontalWall() {
        ...
        try {
            ...
            assertFalse(game.getBoard().get(2).isWallUp());
            assertFalse(game.getBoard().get(2).isWallLeft());
            assertFalse(game.getBoard().get(2).isWallDown());
            assertFalse(game.getBoard().get(2).isWallRight());
            ...
            assertFalse(game.getBoard().get(Game.SIDE_LENGTH + 2).isWallRight());
        }
    }
    ...
    public void testLeftOverlapHorizontalWall() {
        ...
        try {
            ...
            assertFalse(game.getBoard().get(2).isWallUp());
            assertFalse(game.getBoard().get(2).isWallLeft());
            assertTrue(game.getBoard().get(2).isWallDown());
            assertFalse(game.getBoard().get(2).isWallRight());

            //cell to the bottom right of wall
            assertTrue(game.getBoard().get(Game.SIDE_LENGTH + 2).isWallUp());
            assertFalse(game.getBoard().get(Game.SIDE_LENGTH + 2).isWallLeft());
            assertFalse(game.getBoard().get(Game.SIDE_LENGTH + 2).isWallDown());
            assertFalse(game.getBoard().get(Game.SIDE_LENGTH + 2).isWallRight());
    ...
    public void testDeleteHorizontalWall() {
       try {
           ...
           //cell to the top right of wall
           assertFalse(game.getBoard().get(3).isWallUp());
           assertFalse(game.getBoard().get(3).isWallLeft());
           assertFalse(game.getBoard().get(3).isWallDown());
           assertFalse(game.getBoard().get(3).isWallRight());
